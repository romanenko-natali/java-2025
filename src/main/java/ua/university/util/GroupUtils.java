...
public class GroupUtils {
    ...
    public static void validateSpecialty(String specialty) {
        if (specialty == null) {
            throw new InvalidDataException(
                    "Specialty is null. Must be 2-100 characters long and contain only letters, spaces, hyphens, or apostrophes."
            );
        }
        ...
        if (trimmed.isEmpty()) {
            throw new InvalidDataException(
                    String.format("Specialty is blank after trimming. Original value: '%s', Must be 2-100 characters long and contain only letters, spaces, hyphens, or apostrophes.", specialty)
            );
        }
        ...
        if (!ValidationHelper.isStringMatchPattern(trimmed, "^[a-zA-Z\\s\\-']{2,100}$")) {
            throw new InvalidDataException(
                    String.format(
                            "Invalid specialty: '%s'. Must be 2-100 characters long and contain only letters, spaces, hyphens, or apostrophes.",
                            specialty
                    )
            );
        }
